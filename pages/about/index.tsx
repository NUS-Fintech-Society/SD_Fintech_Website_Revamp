                ...
                <div className='flex items-center'>
                  <div className='mr-2'>
                    ...
                    <svg width="36" height="39" viewBox="0 0 36 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M21.4458 10.7806C15.562 15.9645 10.396 22.2148 5.40524 28.9168C4.89157 26.6951 4.61722 24.5772 5.12505 22.3037L6.08819
                        ...
                        30.0899 7.17314 30.097 7.00555 30.1521C6.83796 30.2072 6.68212 30.3088 6.54933 30.4498C5.11922 32.4641 3.71829 34.508 2.36406
                          ...
                          19.0726 21.4458 10.7806Z" fill="white"/>
                    </svg>
                  </div>
                  Our Story
                </div>
                ...
                <h2 className="text-h2 font-bold text-white">
                  <div className='flex items-center'>
                    ...
                    <svg width="45" height="36" viewBox="0 0 45 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M29.3467 17.9658L24.4855 24.3077L15.2682 11.1795V6.05128L25.7351 5.88034L23.1676 2.94017L25.7351
                      0H13.9245V11.1795L0 36H45L29.3467 17.9658ZM15.2682 1.30769H22.8167L21.396 2.90598L22.8252 4.5641L15.2339
                        ...
                        34.4701H2.61031L14.6691 12.9915Z" fill="white"/>
                    </svg>
                    </div>
                    Mission
                  </div>
                ...
                <h2 className="text-h2 font-bold text-white">
                  <div className='flex items-center'>
                    ...
                    <svg width="26" height="39" viewBox="0 0 26 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M7.76256 31.5601C7.74535 31.3253 7.74535 31.0895 7.76256 30.8547C8.2873 27.3192 6.71307
                      ...
                      17.2716C15.866 17.1684 15.6423 17.7619 15.6939 18.3641C15.7456 18.6308 16.0294 18.8716 16.1241 19.0179Z" fill="white"/>
                    </svg>
                    </div>
                    Vision
                  </div>
