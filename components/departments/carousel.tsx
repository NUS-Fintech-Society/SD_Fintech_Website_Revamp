...
const DeptCarousel = ({
  ...
  return (
    <div className='relative h-[400px] w-[408px] rounded-3xl bg-[#090071]'>
      <Image
      ...
      <Carousel>
        <div className='px-14 text-white'>
          ...
          <p className="mt-7 flex text-xl lg:text-2xl">{purpose}</p>
        </div>
        <div className='px-14'>
            <h2 className="mt-14 flex pb-3 text-3xl font-semibold text-white">Vision</h2>
            <p className="mt-7 flex justify-start text-xl text-white lg:text-2xl">{vision}</p>
        </div>
        <div className='px-14'>
