...
const Departments = ({ name, logo, purpose, vision, directors, roles, projects }: DepartmentsProps) => {
  return (
    <>
      <DepartmentInfo name={name} logo={logo} purpose={purpose} vision={vision} directors={directors} roles={roles} />
