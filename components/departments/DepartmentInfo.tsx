  ...
  return (
    <MaxWidth>
      <div className="mt-3 flex flex-wrap font-bold text-[#002750] text-[24.48px] leading-8 ">
        ...
        <h1 className="ml-4 mt-3 sm:text-[60px] sm:leading-[4.538rem] sm:mt-10 sm:ml-6">{`${name}`}</h1>
      </div>

      <div className='mt-10 h-[287.65px] w-[293.41px] sm:h-[400px] sm:w-[798px] rounded-[12.86px] sm:rounded-[20px] bg-black text-white'>
        ...
        <ul className="space-y-11 ml-5 text-[13.8px] leading-[1.044rem] sm:text-[22px] sm:leading-[1.688rem] sm:ml-12 font-normal ">
