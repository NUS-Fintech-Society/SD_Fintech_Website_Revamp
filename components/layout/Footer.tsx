...
const Footer = () => {
  return (
    // [calc(60vh-64px)]
    <footer className="relative bottom-0 mt-20 h-[175px] w-screen items-end sm:h-[160px]">
      ...
      <MaxWidth>
        <div className="flex flex-col-reverse items-center gap-y-2.5 sm:flex-row sm:justify-between sm:gap-y-0">
          <div className="relative h-[60px] w-[120px] sm:mt-10 sm:h-[77px] sm:w-[144px]">
            <Image
          ...
          <div className="flex-col">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://twitter.com/blockchainNUS"
              ...
              <a
                href="https://medium.com/@nusfintech.bc"
              ...
              <a
                href="https://medium.com/@nusfintech.ml"
