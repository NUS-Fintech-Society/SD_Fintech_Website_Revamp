...
const SignUp = () => {
    return (
        <MaxWidth>
            <div className="rounded-lg bg-[#EEF6FE] p-6 md:p-14 block">
                <div className="grid grid-flow-col grid-rows-4 lg:grid-rows-3 gap-10 lg:gap-20 text-[#004C98]">
                    ...
                    <div className="w-[300px] sm:w-[320px] md:w-2/3">
                        ...
                        <h1 className="mb-3 md:text-xl">Missed our Welcome Tea?<br />Watch the recordings <a className="font-bold underline underline-offset-1" href="https://drive.google.com/file/d/1OSCo00YSh07ZsptqTdQfMZdgenLuNrdG/view?usp=sharing">here!</a></h1>
                    </div>
                    <div className="w-[300px] lg:grid md:w-[700px] md:grid-cols-2 md:gap-x-24 md:gap-y-0">
                        <div>
                        <h1 className="mb-1 text-2xl font-bold md:text-4xl">FAQs</h1>
                        <h1 className="mb-3 md:text-xl">Have questions?<br />Take a look at our FAQs on recruitment <span className="font-bold underline underline-offset-1">here</span></h1>
                        </div>
