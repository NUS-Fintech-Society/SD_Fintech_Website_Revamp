  ...
  departments: [
    {
      ...
      coverImage: {
        src: '/images/departments/departmentLogos/ML main icon.svg',
        alt: 'random image 1',
      },
      cardDescription:
      ...
      faq: [
        {
          ...
          answer:
            ' Lorem ipsum dolor, sit amet consectetur adipisicing elit. Doloribus asperiores eius aperiam suscipit quia tempora reprehenderit, laudantium eveniet ullam ipsam.',
        },
        {
          question: 'What is the workload like?',
          answer:
            'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Doloribus asperiores eius aperiam suscipit quia tempora reprehenderit, laudantium eveniet ullam ipsam.',
        },
      ],
    },
    {
      ...
      wingType: WingType.Technical,
      coverImage: {
        src: '/images/departments/departmentLogos/SD main icon.svg',
        alt: 'random image 2',
      },
      cardDescription:
    ...
    },
    {
      ...
      wingType: WingType.Technical,
      coverImage: {
        src: '/images/departments/departmentLogos/BC main icon.svg',
        alt: 'random image 2',
      },
      cardDescription:
    ...
    },
    {
      ...
      coverImage: {
        src: '/images/departments/departmentLogos/Ops main icon.svg',
        alt: 'random image 2',
      },
      cardDescription:
