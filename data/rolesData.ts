    ...
    roles: [
        {
            ...
            roleDescription: {
                ...
                desc: [
                    'As a Software Engineer, you will be tasked to develop web-based applications and features as required. By the end of the semester, you will be expected to deliver stable and user-friendly applications, and see your work to deployment, Work closely with design teams to implement user interfaces. Engage in regular scrum meetings for project management.',
                ],
            },
            requirements: {
                header: 'Requirements',
