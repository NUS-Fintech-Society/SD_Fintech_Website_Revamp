  ...
  roles: [
    {
      ...
      subteams: [
        ...
        },
        {
          teamName: 'Design',
          teamDescription:
            'In the design team, you are tasked with designing and prototyping applications, and setting the design vision for Fintech Society',
          teamImage: {
      ...
      subteams: [
        {
          teamName: 'Project',
          teamDescription:
            'You will collaborate on Fintech ML projects led by the project Tech Lead. The project lasts for one semester and you, alongside your team, may choose to extend it for a second semester',
          teamImage: {
        ...
        },
        {
          teamName: 'Quant',
          teamDescription:
            'You will work in teams on Algorithmic Trading or Quantitative Research projects where you will get to develop and test algorithmic trading strategies and quantitative research ideas.',
          teamImage: {
    ...
    },
    {
      ...
      logo: {
        src: '/images/recruitment/Roles Icon/ER - Business Development Lead.svg',
        alt: 'ER logo',
      },
      aboutUs: {
        header: 'About Us',
      ...
      roleDescription: {
        header: 'Role Description',
        desc: [
          '• Lead the business development executives in their daily tasks, as well as strategise with the presidents and other directors with regards to partnership matters.',
      ...
      requirements: {
        ...
        desc: [
          ...
          '• Interested to lead a team of other businss development executives, able to meet deadlines.',
    ...
    },
    {
      ...
      logo: {
        src: '/images/recruitment/Roles Icon/ER - Business Development Executive.svg',
        alt: 'ER logo',
      },
      aboutUs: {
        header: 'About Us',
